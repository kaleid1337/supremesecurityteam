                ...
                <div id="sidebar">
                    ...
                    <div id="sidebar-brand" class="themed-background">
                        <a href="index.php" class="sidebar-title">
                            <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide"><?php echo $settings['bootername_1']; ?><strong><?php echo $settings['bootername_2']; ?></strong></span>
                        </a>
                    </div>
                    <!-- END Sidebar Brand -->
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                               ...
                               <li>
                                ...
                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-bars sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Logs / Stats</span></a>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                        <a href="index.php?page=Staff-Stats">Site Statistics</a>
                                        </li>
...
<li>
                                    <a href="index.php?page=News"><i class="fa fa-bullhorn sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">News</span></a>
                                </li>
                                <li>
