...
function slack($message, $channel)
{
    ...
    $data = http_build_query([
        "token" => "xoxp-397406072819-397296426916-402428246323-e493dec95db88d0e6183b12e4881e89d",
...
class xWAF {
	...
	function customIPHeader($String = 'HTTP_X_FORWARDED_FOR') {
