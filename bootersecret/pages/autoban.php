        ...
        <div id="error-container">
            <div class="row text-center">
                <div class="col-md-6 col-md-offset-3">
                    <h1 class="text-light animation-fadeInQuick"><strong>You're Banned</strong></h1>
                    <h2 class="text-muted animation-fadeInQuickInv"><em>Your IP Address Has Been Banned From This Website</em></h2>
                </div>
