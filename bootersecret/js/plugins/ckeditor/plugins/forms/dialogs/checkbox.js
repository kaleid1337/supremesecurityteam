        ...
        contents: [{
            ...
            elements: [{
                ...
                setup: function(a) {
                    ...
                    this.setValue(CKEDITOR.env.ie && "checked" == a ? "unchecked" : a)
                },
                commit: function(a) {
                    var b = a.element,
                        c = this.getValue();
                    c && !(CKEDITOR.env.ie && "checked" == c) ? b.setAttribute("value", c) : CKEDITOR.env.ie ? (c = new CKEDITOR.dom.element("input", b.getDocument()), b.copyAttributes(c, {
                        value: 1
